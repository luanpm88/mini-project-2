                ...
                jQuery.ajax({
                    ...
                    success: function (data) {
                        ...
                        if ( reply.status.includes('success') ) {
                            ...
                            $('.td-box-control-fb-account-user').find('.about-wrap').addClass('td-no-fb-account-message').html('<div class="td-fb-user-wrap"><p><strong>No facebook account connected!</strong></p></div>');
